...
<html>
    <body>
        <h1>Ejemplo plantilla Javier Manzano Gamaza</h1>
        <xsl:apply-templates/>
    </body>
</html>
</xsl:template>
...
<xsl:template match="libreria">
    <h2>Mi biblioteca Javier Manzano Gamaza</h2>
    <table>
        <tr bgcolor="#887788">
           ...
           <td><xsl:value-of select="precio"/></td>
            ...
            <xsl:choose>
                <xsl:when test="numpagina &gt; 150">
                    ...
                    <xsl:apply-templates select="numpagina"/>
